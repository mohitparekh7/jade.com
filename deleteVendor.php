...
$re = mysqli_query($con, "select * from product where vendor_id='$Vendorid'");
...
if ($re_no) {
    ...
    $im = $vend_row['vendor_img'];
    $em = $vend_row['vendor_email'];
    ...
    mysqli_query($con, "delete from product where vendor_id='$Vendorid'");
